...
def imports (num):
    ...
    try:
        while True:
            ...
            count=cursor.execute('SELECT username FROM `wangwang_tmall` where type = 1 and displayRateSum < 500 ORDER BY `displayRateSum` DESC limit 1 ')
